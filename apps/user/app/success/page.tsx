    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-8 flex flex-col items-center">
        ...
        <div className="bg-green-400 rounded-full p-4 mb-4">
          <svg width="48" height="48" fill="none"><circle cx="24" cy="24" r="24" fill="#4ade80"/><path d="M16 25l6 6 10-12" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/></svg>
        </div>
        <h2 className="text-2xl font-bold text-center mb-4">결제에 성공하였습니다.</h2>
